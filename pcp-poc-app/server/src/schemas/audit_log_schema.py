...
class AuditLogDB: 
    ...
    def __repr__(self): 
        return f"AuditLog(id={self.id}, event_id={self.event_id}, table_altered={self.table_altered}, event_date={self.event_date}, event_type={self.event_type}, previous_value={self.previous_value}, updated_value={self.updated_value}, actor={self.actor})"
