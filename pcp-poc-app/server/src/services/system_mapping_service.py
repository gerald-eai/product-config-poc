...
class SystemMappingUpdateService: 
    ...
    def update_existing_entry(self, update_id: int, modified_sys_map: UpdateSystemMapUpdate): 
        modified_sys_map_obj = self.repository.updated_existing_entry(update_id, modified_sys_map)
