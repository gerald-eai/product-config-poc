...
from db.contact_tanks_repository import ContactTankRepository, ContactTankUpdatesRepository
...
class ContactTankUpdateService: 
    ...
    def update_existing_entry(self, update_id: int, modified_tank: UpdateContactTankRequest): 
        modified_tank_obj = self.repository.update_existing_entry(update_id, modified_tank)
