...
from .router import default, sres_endpoints, system_mapping_endpoints, contact_tank_endpoints, audit_endpoints, adf_endpoints
...
api_router.include_router(adf_endpoints.router)